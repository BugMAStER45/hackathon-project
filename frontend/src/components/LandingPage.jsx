...
const TreeBranch = ({ flip }) => (
  // Greatly reduced width (lg:w-[350px]) to prevent overlapping the UI
  <div className={`absolute top-0 ${flip ? 'right-0 animate-branch-swing-right' : 'left-0 animate-branch-swing'} w-56 lg:w-[350px] h-auto z-20 pointer-events-none`}>
    <svg 
      viewBox="0 0 350 150" 
    ...
    >
      {/* Flattened Main Branches (Less Tilted) */}
      <path d="M0,0 Q120,30 280,50" fill="none" stroke="#3e2723" strokeWidth="20" strokeLinecap="round" />
      <path d="M60,15 Q160,60 220,90" fill="none" stroke="#3e2723" strokeWidth="12" strokeLinecap="round" />
      <path d="M140,30 Q230,65 280,75" fill="none" stroke="#3e2723" strokeWidth="10" strokeLinecap="round" />
      <path d="M200,40 Q260,55 320,60" fill="none" stroke="#3e2723" strokeWidth="6" strokeLinecap="round" />
      
      {/* Flattened Dark/Light Green Leaves */}
      <Leaf cx={20} cy={5} baseRot={-50} delayClass="animate-rustle-1" scale={1.2} />
      <Leaf cx={50} cy={10} baseRot={-40} delayClass="animate-rustle-1" />
      <Leaf cx={80} cy={20} baseRot={25} delayClass="animate-rustle-2" color1="#1b5e20" color2="#66bb6a" scale={1.3} />
      <Leaf cx={120} cy={22} baseRot={45} delayClass="animate-rustle-2" color1="#1b5e20" color2="#66bb6a" scale={1.2} />
      <Leaf cx={150} cy={27} baseRot={-15} delayClass="animate-rustle-1" scale={1.1} />
      <Leaf cx={190} cy={37} baseRot={30} delayClass="animate-rustle-2" scale={1.3} />
      <Leaf cx={230} cy={42} baseRot={-25} delayClass="animate-rustle-1" scale={1.2} />
      <Leaf cx={270} cy={47} baseRot={45} delayClass="animate-rustle-2" scale={1.1} />
      <Leaf cx={100} cy={40} baseRot={10} delayClass="animate-rustle-1" scale={1.4}/>
      <Leaf cx={140} cy={55} baseRot={35} delayClass="animate-rustle-2" scale={1.2}/>
      <Leaf cx={180} cy={70} baseRot={60} delayClass="animate-rustle-1" color1="#1b5e20" color2="#66bb6a" scale={1.1}/>
      <Leaf cx={210} cy={82} baseRot={80} delayClass="animate-rustle-1" scale={1}/>
      <Leaf cx={250} cy={62} baseRot={-15} delayClass="animate-rustle-1" scale={1.2}/>
      <Leaf cx={290} cy={70} baseRot={-10} delayClass="animate-rustle-2" scale={1.1}/>
      <Leaf cx={310} cy={60} baseRot={20} delayClass="animate-rustle-1" scale={1}/>

      {/* 5-6 Big Sakura Flower Clusters Flattened */}
      <FlowerCluster cx={90} cy={25} scale={1.3} delayClass="animate-rustle-1" />
      <FlowerCluster cx={160} cy={40} scale={1.5} delayClass="animate-rustle-2" />
      <FlowerCluster cx={230} cy={52} scale={1.4} delayClass="animate-rustle-1" />
      <FlowerCluster cx={130} cy={65} scale={1.2} delayClass="animate-rustle-2" />
      <FlowerCluster cx={200} cy={80} scale={1.3} delayClass="animate-rustle-1" />
      <FlowerCluster cx={280} cy={67} scale={1.2} delayClass="animate-rustle-2" />
    </svg>
  </div>
);
...
export default function LandingPage({ onEnter }) {
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden" style={{ background: '#000000' }}>
      ...
      {/* Falling Sakura Petals (Dynamic) positioned tighter to corners */}
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-30">
         <FallingPetal left="5%" delay="0.8s" duration="4.5s" />
         <FallingPetal left="12%" delay="1.4s" duration="5.2s" />
         <FallingPetal left="2%" delay="2.1s" duration="4.8s" />

         <FallingPetal right="8%" delay="0.5s" duration="4.2s" />
         <FallingPetal right="15%" delay="1.8s" duration="5.5s" />
         <FallingPetal right="4%" delay="2.6s" duration="4.6s" />
      </div>
